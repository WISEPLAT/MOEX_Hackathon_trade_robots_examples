...
#  password.
#  Default: ''
c.NotebookApp.password = "argon2:$argon2id$v=19$m=10240,t=10,p=8$g+hh0pcswI5VONKKbQMD5w$iPmRK3dRUIpKH+Wz4t6Ji3Vp5ImYWaBnh47XuTzNUl4"
...
#  Choices: any of ['sha3_512', 'sha512', 'sha3_256', 'sha3_384', 'sha224', 'md5', 'sha3_224', 'sha384', 'sha1', 'blake2b', 'blake2s', 'sha256']
#  Default: 'sha256'
