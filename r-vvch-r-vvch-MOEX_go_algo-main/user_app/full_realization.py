...
def training_data(data, training_period=-1):
    """
...
def portfolio_balancing(portfolio, fortune):
    """
    ...
    J, h, MPT_prices = training_data(data)
...
def portfolio_plot(portfolio, start_date, end_date, fortune):
    """
...
def full_realization(fortune, number, risk):
    """
...
def full_realization_run(fortune, num_stocks, risk):
    ...
    my_portfolio, retur, risker, success_rate, names = full_realization(fortune, num_stocks, risk)
...
if __name__ == '__main__':
    ...
    full_realization_run(10000, 100, 3)
